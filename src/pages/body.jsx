      ...
      return (
        <div>
          ...
          <div className="content">
            <p>1.<img src="logo-dai-ichi-life.png" alt="dai ichi life" title="dai ichi life" width="100x" height="50px" /></p>
            ...
            <div className="Dazone">
              <p>2.<img src="Dazone.png" alt="dai ichi life" title="Dazone" width="200px" height="160x" /></p>
              <div className="Detail">
                <ul>
            ...
            <div className="CloudAce">
              <p>3.<img src="Cloud ace.jpg" alt="dai ichi life" title="Cloud ace" width="100x" height="90px" /></p>
              <div className="Detail">
                <ul>
            ...
            <div className="Navigo">
              <p>4.<img src="Navigo.jpg" alt="Navigo" title="Navigo" width="100x" height="90px" /></p>
              <div className="Detail">
                <ul>
            ...
            <div className="S">
              <p>5.<img src="S.jpg" alt="S" title="S" width="90px" height="90px" /></p>
              <div className="Detail">
                <ul>
